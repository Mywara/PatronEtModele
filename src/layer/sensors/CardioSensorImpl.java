 ...
 *
 */
public class CardioSensorImpl implements Sensor {
	...
	public CardioSensorImpl(int id, String name, String measureUnit, Agent ag) {
		super();
		this.id = id;
		this.name = name;
	...
	public void run(){
		...
		try {
			sJFrame = new SensorJFrame(this,"images/cardio.png");
	...
	public void generateValue() {
		...
		int min = 60;
		int range = max - min;
		int r = min + random.nextInt(Math.abs(range));
		this.setValue(r);
